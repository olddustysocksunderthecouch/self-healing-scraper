...
import { scrape, ScrapeResult } from '../src/scraper/seeffScraper.js';
import { urlPatterns } from '../src/scraper/seeffScraper.js';
import { findBestMatch } from '../src/utils/urlPatternMatcher.js';

describe('seeffScraper scraper', () => {
  it('scrapes data correctly from the fixture HTML', async () => {
    const __dirname = path.dirname(new URL(import.meta.url).pathname);
    const filePath = path.resolve(__dirname, 'fixtures', 'seeffScraper.html');
  ...
  it('has valid URL patterns for pattern matching', () => {
    ...
    const testUrl = 'https://www.seeff.com/results/residential/for-sale/cape-town/rondebosch/freehold/2494125/';
  ...
  it.skip('scrapes live website', async () => {
    const result = await scrape('https://www.seeff.com/results/residential/for-sale/cape-town/rondebosch/freehold/2494125/');
