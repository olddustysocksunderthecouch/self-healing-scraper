...
import { scrape, ScrapeResult } from '../src/scraper/quay1Scraper.js';
import { urlPatterns } from '../src/scraper/quay1Scraper.js';
import { findBestMatch } from '../src/utils/urlPatternMatcher.js';

describe('quay1Scraper scraper', () => {
  it('scrapes data correctly from the fixture HTML', async () => {
    const __dirname = path.dirname(new URL(import.meta.url).pathname);
    const filePath = path.resolve(__dirname, 'fixtures', 'quay1Scraper.html');
  ...
  it('has valid URL patterns for pattern matching', () => {
    ...
    const testUrl = 'https://www.quay1.co.za/results/residential/for-sale/kraaifontein/zoo-park/house/6297/';
